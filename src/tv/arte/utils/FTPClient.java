...
public class FTPClient {
	 ...
	 */
	public synchronized boolean uploadFile(String localPath, String localfilename, String remoteFile) {
		try {

			InputStream is = new FileInputStream(localPath + File.separator + localfilename);
	...
	public synchronized boolean connect(String host, String username, String password, String remoteFile) {
